<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DriverLogin.aspx.cs" Inherits="lkhassignment.DriverLogin" %>
...
<body>
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/DriverLogin.aspx">Sign up</asp:HyperLink>
        <br />
        <br />
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/DriverForgotPassword.aspx">I forgot my password</asp:HyperLink>
        <br />
        <br />
