<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DriverForgotPassword.aspx.cs" Inherits="lkhassignment.DriverForgotPassword" %>
...
<body>
    ...
    <div>
        ...
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/DriverLogin.aspx">Back To Menu</asp:HyperLink>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
